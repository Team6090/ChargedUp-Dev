...
public final class SwerveModuleConstants {
  ...
  /* MK4 L2 */
  public static final double MK4_L2_WHEEL_DIAMETER_METERS = 0.1011; // .113
  ...
  public static final double MK4_L2_DRIVE_GEAR_RATIO =
      1 / ((16.0 / 50.0) * (28.0 / 16.0) * (15.0 / 60.0));
  ...
  public static final double DRIVE_KS = (0.53724 / 12); // 0.55493 1/14/23
  public static final double DRIVE_KV = (2.35795 / 12); // 2.3014 1/14/23
